...
<head>
  ...
  <title><c:out value='${category.categoryId == null ? "Add New Category" : "Edit Category"}'/></title>
      ...
      <div class="card-body">
        <form action="<c:url value='/admin/categories/saveOrUpdate'/>" method="post" autocomplete="off">
          ...
          <div class="d-flex gap-2">
            <a class="btn btn-secondary" href="<c:url value='/admin/categories/add'/>"><i class="bi bi-plus-circle me-1"></i>New</a>
            <a class="btn btn-success" href="<c:url value='/admin/categories'/>"><i class="bi bi-list-ul me-1"></i>List Categories</a>
