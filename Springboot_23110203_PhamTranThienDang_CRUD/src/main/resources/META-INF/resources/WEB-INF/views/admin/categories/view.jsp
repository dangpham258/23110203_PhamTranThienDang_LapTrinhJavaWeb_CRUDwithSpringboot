...
<body class="bg-light">
  <div class="container py-4">
    <div class="d-flex align-items-center justify-content-between mb-3">
      <h1 class="h5 m-0">Chi tiết Danh mục</h1>
      <div class="d-flex gap-2">
        <a class="btn btn-success" href="<c:url value='/admin/categories'/>"><i class="bi bi-list-ul me-1"></i>Danh sách</a>
        <a class="btn btn-warning" href="<c:url value='/admin/categories/edit/${category.categoryId}'/>"><i class="bi bi-pencil-square me-1"></i>Sửa</a>
      </div>
    </div>
    ...
    <div class="card shadow-sm">
      <div class="card-body">
        <dl class="row mb-0">
          ...
          <dt class="col-sm-3">Mã danh mục</dt>
